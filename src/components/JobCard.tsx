...
export default function JobCard({ job, matchScore }: JobCardProps) {
  ...
  return (
    <div className="glass-card p-6 flex flex-col h-full group relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-brand-primary/0 to-transparent opacity-0 group-hover:opacity-10 transition-opacity duration-500" />
      
      <div className="flex justify-between items-start mb-4 relative z-10">
        <div className="flex-1">
          <h3 className="text-xl font-bold font-sans text-brand-light line-clamp-2 leading-tight mb-2">
            {job.title}
          </h3>
      ...
      <p className="text-slate-400 text-sm line-clamp-3 mb-6 relative z-10 font-light rendering-geometricPrecision">
        {job.description}
      </p>
